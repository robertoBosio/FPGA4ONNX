...
global_in_1_buffer = allocate(shape=(577158,), dtype="uint32")
global_in_1_data = np.random.randint(0, 4294967295, size=(577158,), dtype="uint32")
...
StreamingConcat_27_out0_buffer = allocate(shape=(1152000,), dtype=np.int8)
StreamingConcat_27_out0_buffer[:] = 0
StreamingConcat_27_out0_addr = StreamingConcat_27_out0_buffer.device_address
write_u64(kernel, 0x28, StreamingConcat_27_out0_addr)
write_u64(kernel, 0x34, StreamingConcat_27_out0_addr)
...
write_u64(kernel, 0x40, StreamingTensorDuplicator_11_out1_addr)
write_u64(kernel, 0x4C, StreamingTensorDuplicator_11_out1_addr)
...
write_u64(kernel, 0x58, StreamingReshape_1_out0_addr)
write_u64(kernel, 0x64, StreamingReshape_1_out0_addr)
BandwidthAdjustIncreaseWord_18_out0_buffer = allocate(shape=(409600,), dtype=np.int8)
BandwidthAdjustIncreaseWord_18_out0_buffer[:] = 0
BandwidthAdjustIncreaseWord_18_out0_addr = BandwidthAdjustIncreaseWord_18_out0_buffer.device_address
write_u64(kernel, 0x70, BandwidthAdjustIncreaseWord_18_out0_addr)
write_u64(kernel, 0x7C, BandwidthAdjustIncreaseWord_18_out0_addr)
StreamingConv_46_out0_buffer = allocate(shape=(409600,), dtype=np.int8)
StreamingConv_46_out0_buffer[:] = 0
StreamingConv_46_out0_addr = StreamingConv_46_out0_buffer.device_address
write_u64(kernel, 0x88, StreamingConv_46_out0_addr)
write_u64(kernel, 0x94, StreamingConv_46_out0_addr)
...
BandwidthAdjustIncreaseWord_10_out0_buffer = allocate(shape=(204800,), dtype=np.int8)
BandwidthAdjustIncreaseWord_10_out0_buffer[:] = 0
BandwidthAdjustIncreaseWord_10_out0_addr = BandwidthAdjustIncreaseWord_10_out0_buffer.device_address
write_u64(kernel, 0xB8, BandwidthAdjustIncreaseWord_10_out0_addr)
write_u64(kernel, 0xC4, BandwidthAdjustIncreaseWord_10_out0_addr)
StreamingTensorDuplicator_17_out1_buffer = allocate(shape=(51200,), dtype=np.int8)
StreamingTensorDuplicator_17_out1_buffer[:] = 0
StreamingTensorDuplicator_17_out1_addr = StreamingTensorDuplicator_17_out1_buffer.device_address
write_u64(kernel, 0xD0, StreamingTensorDuplicator_17_out1_addr)
write_u64(kernel, 0xDC, StreamingTensorDuplicator_17_out1_addr)
StreamingDepthwiseConv_2_out0_buffer = allocate(shape=(51200,), dtype=np.int8)
StreamingDepthwiseConv_2_out0_buffer[:] = 0
StreamingDepthwiseConv_2_out0_addr = StreamingDepthwiseConv_2_out0_buffer.device_address
write_u64(kernel, 0xE8, StreamingDepthwiseConv_2_out0_addr)
write_u64(kernel, 0xF4, StreamingDepthwiseConv_2_out0_addr)
...
release_buffer(StreamingConcat_27_out0_buffer)
release_buffer(StreamingTensorDuplicator_11_out1_buffer)
release_buffer(StreamingReshape_1_out0_buffer)
release_buffer(BandwidthAdjustIncreaseWord_18_out0_buffer)
release_buffer(StreamingConv_46_out0_buffer)
release_buffer(StreamingReshape_0_out0_buffer)
release_buffer(BandwidthAdjustIncreaseWord_10_out0_buffer)
release_buffer(StreamingTensorDuplicator_17_out1_buffer)
release_buffer(StreamingDepthwiseConv_2_out0_buffer)
