...
global_in_1_buffer = allocate(shape=(663976,), dtype="uint32")
global_in_1_data = np.random.randint(0, 4294967295, size=(663976,), dtype="uint32")
...
BandwidthAdjustIncreaseWord_9_out0_buffer = allocate(shape=(409600,), dtype=np.int8)
BandwidthAdjustIncreaseWord_9_out0_buffer[:] = 0
BandwidthAdjustIncreaseWord_9_out0_addr = BandwidthAdjustIncreaseWord_9_out0_buffer.device_address
write_u64(kernel, 0x10, BandwidthAdjustIncreaseWord_9_out0_addr)
write_u64(kernel, 0x1C, BandwidthAdjustIncreaseWord_9_out0_addr)
StreamingReshape_1_out0_buffer = allocate(shape=(230400,), dtype=np.int8)
StreamingReshape_1_out0_buffer[:] = 0
StreamingReshape_1_out0_addr = StreamingReshape_1_out0_buffer.device_address
write_u64(kernel, 0x28, StreamingReshape_1_out0_addr)
write_u64(kernel, 0x34, StreamingReshape_1_out0_addr)
StreamingConcat_16_out0_buffer = allocate(shape=(1152000,), dtype=np.int8)
StreamingConcat_16_out0_buffer[:] = 0
StreamingConcat_16_out0_addr = StreamingConcat_16_out0_buffer.device_address
write_u64(kernel, 0x40, StreamingConcat_16_out0_addr)
write_u64(kernel, 0x4C, StreamingConcat_16_out0_addr)
StreamingConcat_19_out0_buffer = allocate(shape=(1209600,), dtype=np.int8)
StreamingConcat_19_out0_buffer[:] = 0
StreamingConcat_19_out0_addr = StreamingConcat_19_out0_buffer.device_address
write_u64(kernel, 0x58, StreamingConcat_19_out0_addr)
write_u64(kernel, 0x64, StreamingConcat_19_out0_addr)
BandwidthAdjustIncreaseWord_14_out0_buffer = allocate(shape=(204800,), dtype=np.int8)
...
write_u64(kernel, 0x70, BandwidthAdjustIncreaseWord_14_out0_addr)
write_u64(kernel, 0x7C, BandwidthAdjustIncreaseWord_14_out0_addr)
BandwidthAdjustIncreaseWord_19_out0_buffer = allocate(shape=(204800,), dtype=np.int8)
BandwidthAdjustIncreaseWord_19_out0_buffer[:] = 0
BandwidthAdjustIncreaseWord_19_out0_addr = BandwidthAdjustIncreaseWord_19_out0_buffer.device_address
write_u64(kernel, 0x88, BandwidthAdjustIncreaseWord_19_out0_addr)
write_u64(kernel, 0x94, BandwidthAdjustIncreaseWord_19_out0_addr)
...
write_u64(kernel, 0xA0, StreamingReshape_0_out0_addr)
write_u64(kernel, 0xAC, StreamingReshape_0_out0_addr)
StreamingReshape_2_out0_buffer = allocate(shape=(57600,), dtype=np.int8)
StreamingReshape_2_out0_buffer[:] = 0
StreamingReshape_2_out0_addr = StreamingReshape_2_out0_buffer.device_address
write_u64(kernel, 0xB8, StreamingReshape_2_out0_addr)
write_u64(kernel, 0xC4, StreamingReshape_2_out0_addr)
StreamingConv_54_out0_buffer = allocate(shape=(409600,), dtype=np.int8)
StreamingConv_54_out0_buffer[:] = 0
StreamingConv_54_out0_addr = StreamingConv_54_out0_buffer.device_address
write_u64(kernel, 0xD0, StreamingConv_54_out0_addr)
write_u64(kernel, 0xDC, StreamingConv_54_out0_addr)
BandwidthAdjustIncreaseWord_28_out0_buffer = allocate(shape=(409600,), dtype=np.int8)
BandwidthAdjustIncreaseWord_28_out0_buffer[:] = 0
BandwidthAdjustIncreaseWord_28_out0_addr = BandwidthAdjustIncreaseWord_28_out0_buffer.device_address
write_u64(kernel, 0xE8, BandwidthAdjustIncreaseWord_28_out0_addr)
write_u64(kernel, 0xF4, BandwidthAdjustIncreaseWord_28_out0_addr)
StreamingSplit_0_out0_buffer = allocate(shape=(537600,), dtype=np.int8)
StreamingSplit_0_out0_buffer[:] = 0
StreamingSplit_0_out0_addr = StreamingSplit_0_out0_buffer.device_address
write_u64(kernel, 0x100, StreamingSplit_0_out0_addr)
write_u64(kernel, 0x10C, StreamingSplit_0_out0_addr)
StreamingConcat_5_out0_buffer = allocate(shape=(153600,), dtype=np.int8)
StreamingConcat_5_out0_buffer[:] = 0
StreamingConcat_5_out0_addr = StreamingConcat_5_out0_buffer.device_address
write_u64(kernel, 0x118, StreamingConcat_5_out0_addr)
write_u64(kernel, 0x124, StreamingConcat_5_out0_addr)
...
release_buffer(BandwidthAdjustIncreaseWord_9_out0_buffer)
release_buffer(StreamingReshape_1_out0_buffer)
release_buffer(StreamingConcat_16_out0_buffer)
release_buffer(StreamingConcat_19_out0_buffer)
release_buffer(BandwidthAdjustIncreaseWord_14_out0_buffer)
release_buffer(BandwidthAdjustIncreaseWord_19_out0_buffer)
release_buffer(StreamingReshape_0_out0_buffer)
release_buffer(StreamingReshape_2_out0_buffer)
release_buffer(StreamingConv_54_out0_buffer)
release_buffer(BandwidthAdjustIncreaseWord_28_out0_buffer)
release_buffer(StreamingSplit_0_out0_buffer)
release_buffer(StreamingConcat_5_out0_buffer)
